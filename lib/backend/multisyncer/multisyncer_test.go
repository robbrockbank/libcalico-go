...
import (
	...
	"github.com/projectcalico/libcalico-go/lib/backend/syncersv1/keyconverters"
...
var _ = Describe("Test the backend datstore multi-watch syncer", func() {
	...
	r1 := watchersyncer.ResourceType{
		...
		KeyConverter:  keyconverters.NewResourceKeyConverter(apiv2.KindNetworkPolicy),
	}
	r2 := watchersyncer.ResourceType{
		ListInterface: model.ResourceListOptions{Kind: apiv2.KindIPPool},
		KeyConverter:  keyconverters.NewResourceKeyConverter(apiv2.KindIPPool),
	}
	r3 := watchersyncer.ResourceType{
		ListInterface: model.BlockAffinityListOptions{},
		KeyConverter:  keyconverters.NewBlockAffinityKeyConverter(),
	}
