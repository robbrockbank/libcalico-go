...
func init() {
	...
	DescribeTable("Validator",
		...
		Entry("should reject a DebuggingConfiguration with configuration for same component/node present multiple times",
			&api.DebuggingConfiguration{
				ObjectMeta: v1.ObjectMeta{Name: "default"},
				Spec: api.DebuggingConfigurationSpec{
					Configuration: []api.ComponentConfiguration{
		...
		Entry("should reject a DebuggingConfiguration with configuration for same component present multiple times",
			&api.DebuggingConfiguration{
				ObjectMeta: v1.ObjectMeta{Name: "default"},
				Spec: api.DebuggingConfigurationSpec{
					Configuration: []api.ComponentConfiguration{
